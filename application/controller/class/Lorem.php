...
class Lorem {
  ...
  /**
  * static function text(nombre de caractères)
  * Retourne un texte brut, sans html
  * Appel : $lorem->text(250);
  **/
  static function text($width) {
    $lorem = "
  ...
  * Vous permet de vérifier le style de tous vos contenus
  * Appel : $lorem->html();
  **/
  static function html() {
    $lorem = "
  ...
  /**
  * static function createList(nombre de li)
  * Vous permet de générer une liste
  * Appel : $lorem->createList(8);
  **/
  static function createList($width) {
    $lorem = '<ul>';
    for($i=0; $i<$width; $i++) {
  ...
  * Vous permet de générer un formulaire contenant tous les types de champs
